...
in
{
  options.modules.zsh = {
    ...
    # which silently set this to `false` because mkEnableOption ignores its
  ...
  config = mkIf cfg.enable (mkMerge [
    # ===== Universal =====
    {
      home.sessionVariables = {
        ...
        GOPATH = "${config.home.homeDirectory}/Projects";
      ...
      home.sessionPath = [
        ...
        "${pkgs.jdk21_headless}/bin"
        "${config.home.homeDirectory}/Projects/bin" # $GOPATH/bin
