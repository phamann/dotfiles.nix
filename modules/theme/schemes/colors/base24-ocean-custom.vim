...
" Scheme name: Ocean Custom
" Scheme author: Chris Kempson (base16-ocean) — base24 extension derived in CAM02-UCS
...
if !has('gui_running')
  if exists('g:tinted_shell_path')
    execute 'silent !/bin/sh '.g:tinted_shell_path.'/base24/ocean-custom.sh'
  endif
endif
...
" Theme setup
let g:colors_name = 'base24-ocean-custom'
